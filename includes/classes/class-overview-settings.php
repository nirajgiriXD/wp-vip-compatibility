...
class Overview_Settings {
	...
	public function render_settings_page() {
		?>
		<h1><?php esc_html_e( 'WordPress VIP Compatibility (WVC)', 'wp-vip-compatibility' ); ?></h1>
		...
		<p>
			...
			printf(
				...
				'<a href="https://docs.wpvip.com/" target="_blank" rel="noopener noreferrer">' . esc_html__( 'WordPress VIP Documentation', 'wp-vip-compatibility' ) . '</a>'
			);
			?>
		</p>
		<?php
